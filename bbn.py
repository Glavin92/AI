...
# a. Calculate the probability that the alarm has sounded (A=True),
# but there is neither a burglary (B=False) nor an earthquake (E=False),
# and John called (J=True) and Mary called (M=True).
query_a = {"Burglary": False, "Earthquake": False, "Alarm": True, "JohnCalls": True, "MaryCalls": True}
